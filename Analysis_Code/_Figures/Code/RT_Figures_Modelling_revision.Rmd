...
params:
  ...
  fits: "..\\..\\_Data\\fits_relative_best.Rds"
  sims: "..\\..\\_Data\\sims_relative.Rds"
  rec:  "..\\..\\_Data\\recovery_Relative_Final_25.Rds"
...
f.model.rec<-
  ggplot(aes(x=recovered,y=real,fill=perc),data=bind_rows(confusion.simple,inversion.simple))+geom_tile()+
    ...
    labs(x = "recovered model", y = "generative model", fill = "Proportion") +
    ...
    theme(panel.background = element_rect(fill = "white", colour = "black"),
          ...
          strip.text = element_text(hjust = 0)) +
    facet_wrap(~type)+
    scale_fill_continuous(limits=c(0,1), breaks=c(0,1))
```
